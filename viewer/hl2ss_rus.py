...
class command_buffer(hl2ss.umq_command_buffer):
    ...
    def set_registration(self, key, position, rotation, scale):
        self.add(9, struct.pack('<Iffffffffff', key, position[0], position[1], position[2], rotation[0], rotation[1], rotation[2], rotation[3], scale[0], scale[1], scale[2]))
